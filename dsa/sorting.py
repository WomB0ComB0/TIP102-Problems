...
from utils.helpers import partition
...
class Sorting:
    ...
    def bubbleSort(
        self, array: List[Any]
    ) -> List[Any]:  # function to implement bubble sort
    ...
    def bucketSort(
        self, array: List[Any]
    ) -> List[Any]:  # Function to sort using bucket sort
    ...
    def countingSort(self, array: List[Any]) -> List[Any]:  # Counting sort function
        size: int = len(array)
        output: List[Any] = [0] * size
    ...
    ) -> int:  # Function to implement Linear Search
        for i in range(0, n):
            if array[i] == x:
                return i
        return -1
    ...
    def mergeSort(
        self, array: List[Any]
    ) -> List[Any]:  #  function to implement merge sort
        if len(array) > 1:
    ...
    ) -> List[Any]:  # function to perform quicksort
        if low < high:
    ...
    ) -> List[Any]:  # function to swap elements at the given index values
    ...
    def shellSort(self, array: List[Any], n: int) -> List[Any]:
